...
public class EmergencyListActivity extends AppCompatActivity {
            ...
            protected void onBindViewHolder(@NonNull EmergencyViewHolder holder, int position,
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        // Use getBindingAdapterPosition() to avoid invalid positions
                        int currentPosition = holder.getBindingAdapterPosition();
                        if (currentPosition == RecyclerView.NO_POSITION) return; // Skip invalid positions

                        String emergencyId = getRef(currentPosition).getKey();
                        if (emergencyId != null) {
    ...
    protected void onStart() {
        super.onStart();
        recyclerView.setAdapter(adapter); // Reattach the adapter
    ...
    protected void onStop() {
        ...
        recyclerView.setAdapter(null); // Detach to prevent updates when not visible
    }
